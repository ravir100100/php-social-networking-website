...
if(isset($_POST['sign_up'])){
	...
	$insert = "insert into users(user_name,user_pass,user_email,user_country,user_gender,user_birthday,user_image,user_reg_date,status,ver_code,posts) values('$name','$pass','$email','$country','birthday','default.jpg',NOW(),'$status','$ver_code','$posts')";
	$query = mysql_query($con,$insert);
	if($query({
